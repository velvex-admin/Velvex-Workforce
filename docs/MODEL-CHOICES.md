...
| Growth-Strategy | Opus 5.5 | `high` | Weekly, and its entire output is a judgement read across marketing and sales together. Ran at `max` until 2026-09-24; moved to `high` because its inputs are thin and more thinking over thin evidence buys confidence rather than accuracy. Opus 5.5 at `high` is above what Opus 5 did at `max`. |
