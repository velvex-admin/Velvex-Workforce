...
**`/method.html` names VDL and VSL in full because this file documents those
expansions. VEF, VHM and VCVP are used as acronyms with their role described
and NOT expanded**, because nothing on file says what those letters stand for
and a method page is the worst place to guess. Fill them in when the owner
supplies them.
